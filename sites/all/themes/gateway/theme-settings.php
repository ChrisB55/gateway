 ...
 */
function gateway_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['gateway_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('gateway sample setting'),
  '#default_value' => theme_get_setting('gateway_example'),
